...
const DEFAULT_MAX_TENSOR_COUNT: usize = 10_000;
const DEFAULT_MAX_TOTAL_ELEMENTS: u64 = 2_000_000_000;
...
fn tensor_elements(snapshot: &TensorSnapshot) -> Result<u64, WeightImportError> {
...
impl SnapshotFile {
    fn copy_from(path: &Path, max_file_bytes: u64) -> Result<Self, WeightImportError> {
